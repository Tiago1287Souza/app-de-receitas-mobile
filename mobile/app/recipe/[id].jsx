...
export default function RecipeDetailScreen() {
  ...
  const handleToggleSave = async () => {
    ...
    try {
      if (isSaved) {
        ...
        if (!response.ok) throw new Error("Falha ao remover o recipe");
  ...
  if (loading) return <LoadingSpinner message="Carregando detalhes..." />;
        ...
        <View style={recipeDetailStyles.contentSection}>
          <View style={recipeDetailStyles.statsContainer}>
            ...
            <View style={recipeDetailStyles.statCard}>
              ...
              <Text style={recipeDetailStyles.statLabel}>Servindo</Text>
            </View>
          </View>
            ...
            <View style={recipeDetailStyles.sectionContainer}>
              ...
              <View style={recipeDetailStyles.videoCard}>
                <WebView
                  ...
                  source={{ uri: getYoutubeEmberUrl(recipe.youtubeUrl) }}
          ...
          <View style={recipeDetailStyles.sectionContainer}>
            <View style={recipeDetailStyles.sectionTitleRow}>
              ...
              <Text style={recipeDetailStyles.sectionTitle}>Instrução</Text>
              <View style={recipeDetailStyles.countBadge}>
                <Text style={recipeDetailStyles.countText}>
